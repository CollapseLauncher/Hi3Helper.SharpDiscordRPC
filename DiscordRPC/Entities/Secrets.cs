...
public class Secrets
{
    ...
    /// </summary>
    [Obsolete("This feature has been deprecated my Mason in issue #152 on the official library. Was originally used as a Notify Me feature, it has been replaced with Join / Spectate.", true)]
    [JsonIgnore]
    public string? MatchSecret;

    /// <summary>
    /// The secret data that will tell the client how to connect to the game to play. This could be a unique identifier for a fancy matchmaker or player id, lobby id, etc.
    /// <para>It is recommended to encrypt this information so it's hard for people to replicate it. 
    ...
    /// <summary>
    /// The secret data that will tell the client how to connect to the game to spectate. This could be a unique identifier for a fancy matchmaker or player id, lobby id, etc.
    /// <para>It is recommended to encrypt this information so it's hard for people to replicate it. 
    /// Do <b>NOT</b> just use the IP address in this. That is a bad practice and can leave your players vulnerable!
    /// </para>
    /// <para>Max Length of 128 characters</para>
    ...
    {
        if (length is < 1 or > SecretLength)
