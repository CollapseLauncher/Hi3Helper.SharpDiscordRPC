...
public class User
{
    ...
    public enum AvatarFormat
    {
        ...
        /// <summary>
        /// WebP format (.webp)
        /// <para>Picture only version of WebM.</para>
        /// </summary>
        WebP,
    ...
    public AvatarDecorationData? AvatarDecoration { get; init; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    public PremiumType Premium { get; init; }
    ...
    public enum PremiumType
    {
        ...
        /// <summary>Nitro Basic. Access to most premium features</summary>
        NitroBasic = 3
    }
...
#pragma warning restore CS0618
        ...
        return $"https://{CdnEndpoint}{endpoint}{GetAvatarExtension(format)}?size={(int)size}&animated=true";
    }

    /// <summary>
    /// Gets a URL to the user's avatar decoration.
    /// </summary>
    /// <remarks>The Image will be an Animated PNG.</remarks>
    ...
    public string? GetAvatarDecorationURL(AvatarFormat format)
    {
        ...
        string endpoint = $"/avatar-decoration-presets/{AvatarDecoration.Asset}";
        return $"https://{CdnEndpoint}{endpoint}{GetAvatarExtension(format)}";
    }
